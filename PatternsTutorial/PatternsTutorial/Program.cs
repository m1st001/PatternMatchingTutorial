...
namespace toll_calculator
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                new DateTime(2019, 3, 4, 8, 0, 0), 
                new DateTime(2019, 3, 6, 11, 30, 0), 
                new DateTime(2019, 3, 7, 17, 15, 0), 
                new DateTime(2019, 3, 14, 03, 30, 0), 

                new DateTime(2019, 3, 16, 8, 30, 0), 
                new DateTime(2019, 3, 17, 14, 30, 0), 
                new DateTime(2019, 3, 17, 18, 05, 0), 
                new DateTime(2019, 3, 16, 01, 30, 0),
            };
